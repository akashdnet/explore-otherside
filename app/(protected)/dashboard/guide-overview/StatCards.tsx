...
export default function StatCards({ totalTours, upcomingTours, completedTours }: StatCardsProps) {
    return (
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="border-none shadow-md bg-linear-to-br from-blue-50 to-indigo-50 dark:from-slate-900 dark:to-slate-900/50">
                ...
                <CardContent>
                    ...
                    <p className="text-xs text-muted-foreground mt-1"> Guide + User</p>
                </CardContent>
            </Card>

            <Card className="border-none shadow-md bg-linear-to-br from-purple-50 to-pink-50 dark:from-slate-900 dark:to-slate-900/50">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Card className="border-none shadow-md bg-linear-to-br from-green-50 to-emerald-50 dark:from-slate-900 dark:to-slate-900/50">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium text-muted-foreground">Total Completed Journeys</CardTitle>
